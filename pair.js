...
} = require('npm:@whiskeysockets/baileys');
...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: '𝘾𝙔𝘽𝙀𝙍 𝙉𝙀𝙏 𝙈𝙄𝙉𝙄 𝘽𝙊𝙏',
    OWNER_NAME: '𝘊𝘙𝘠𝘗𝘛𝘖/𝘒𝘛',
...
//================================ ALIVE ==================================
    ...
    try {
        ...
        const content = 
`𝗜'𝗺 𝘼𝙇𝙔𝘼 𝙈𝘿 𝗠𝗶𝗻𝗶 𝗕𝗼𝘁 𝗠𝗮𝗱𝗲 𝗕𝘆 𝘼𝙇𝙔𝘼 𝘾𝙊𝘿𝙀𝙍𝙎🕊️❤️‍🩹.
...
🌐 ᴀʟʏᴀ ᴍᴅ ᴍɪɴɪ вσт is a lightweight yet powerful WhatsApp user bot ⚡ 
...
𝑩𝑶𝑻 𝑾𝑬𝑩: තව නැතෝ
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
𝑪𝑯𝑨𝑵𝑬𝑳: https://whatsapp.com/channel/0029VbAqDs9ICVfqihKHaD0P
▬▬▬▬▬▬▬▬▬▬▬▬▬▬`;
